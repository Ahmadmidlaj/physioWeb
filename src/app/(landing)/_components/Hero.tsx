...
export default function HeroSection() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post('/api/sendEmail', validatedData);

      // Reset the form data after successful submission
      setFormData({ name: '', phoneNumber: '', city: '' });
      setError(null);
  ...
  return (
                      ...
                      <div className="relative col-span-full">
                        ...
                        <div className="relative">
                          <select
                            ...
                            className="peer p-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:focus:ring-neutral-600
    focus:pt-6
    focus:pb-2
    [&:not(:placeholder-shown)]:pt-6
    [&:not(:placeholder-shown)]:pb-2
    ...
    autofill:pb-2"
                          >
                            ...
                            <option value="Los Angeles">Attavar</option>
                            <option value="Chicago">Hampankatta</option>
                            <option value="Houston">Kankanady</option>
                            <option value="Houston">Falnir</option>
                            <option value="Houston">Pandeshwar</option>
                            <option value="Houston">Jeppu</option>
                            <option value="Houston">Padil</option>
                            <option value="Houston">Carstreet</option>
