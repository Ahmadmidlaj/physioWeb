...
export default function HowitWorks(){
  ...
  <div className="relative z-10 container px-4 mx-auto">
    <p className="mb-6 text-sm text-indigo-600 text-center font-semibold uppercase tracking-px">Physiotherapy Home visits</p>
    <h2 className="mb-20 text-6xl md:text-7xl text-center font-bold font-heading tracking-px-n leading-tight text-black ">How it Works</h2>
    <div className="flex flex-wrap -m-8">
      <div className="w-full md:w-1/2 lg:w-1/4 p-8">
        <div className="text-center">
          ...
          <div className="md:max-w-xs mx-auto">
            <h3 className="mb-4 font-heading text-xl font-bold font-heading leading-normal text-black">Book A Session</h3>
      ...
      <div className="w-full md:w-1/2 lg:w-1/4 p-8">
        <div className="text-center">
          ...
          <div className="md:max-w-xs mx-auto">
            <h3 className="mb-4 font-heading text-xl font-bold font-heading leading-normal text-black">Assessment On call</h3>
            <p className="text-gray-600 font-medium leading-relaxed">Lorem ipsum dolor sit amet consectetur adipiscing elit. Volutpat tempor con.</p>
          </div>
        </div>
      </div>
      <div className="w-full md:w-1/2 lg:w-1/4 p-8">
        <div className="text-center">
          ...
          <div className="md:max-w-xs mx-auto">
            <h3 className="mb-4 font-heading text-xl font-bold font-heading leading-normal text-black">Physiotherapists visit</h3>
            <p className="text-gray-600 font-medium leading-relaxed">Lorem ipsum dolor sit amet consectetur adipiscing elit. Volutpat tempor con.</p>
          </div>
        </div>
      </div>
      <div className="w-full md:w-1/2 lg:w-1/4 p-8">
        <div className="text-center">
          ...
          <div className="md:max-w-xs mx-auto">
            <h3 className="mb-4 font-heading text-xl font-bold font-heading leading-normal text-black">Physiotherapy treatment At home </h3>
            <p className="text-gray-600 font-medium leading-relaxed">Lorem ipsum dolor sit amet consectetur adipiscing elit. Volutpat tempor con.</p>
          </div>
        </div>
      </div>
